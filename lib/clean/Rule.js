...
module.exports = function cleanRuleset(node, item, list, options) {
    ...
    var preludeIsSelectorList = node.prelude.type === 'SelectorList'; //could be Raw. See https://github.com/csstree/csstree/blob/master/docs/ast.md#rule

    if (preludeIsSelectorList && usageData && (usageData.whitelist !== null || usageData.blacklist !== null)) {
        cleanUnused(node.prelude, usageData);
    }

    if (preludeIsSelectorList && node.prelude.children.isEmpty() ||
